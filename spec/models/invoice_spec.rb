  ...
  describe 'class methods' do
    describe '.potential_revenue' do
      it 'returns total revenue of successful invoices which have not yet been shipped' do
        expect(Invoice.potential_revenue(2)).to be_a(Hash)
        expect(Invoice.potential_revenue(2)).to eq({1=>77.5, 2=>100.0})
        expect(Invoice.potential_revenue(3)).to eq({1=>77.5, 2=>100.0, 3=>50.0})
        expect(Invoice.potential_revenue(3)).to_not eq({1=>77.5, 2=>100.0})
      end
    end
  end
